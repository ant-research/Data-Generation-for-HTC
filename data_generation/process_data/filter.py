...
import sys
sys.path.append(".")
from train.train_aug import BertDataset,AugDataset
...
if __name__ == '__main__':
    ...
    aug_dataset = AugDataset(device=device, pad_idx=tokenizer.pad_token_id, data_path=input_dir, tokenizer=tokenizer)        
