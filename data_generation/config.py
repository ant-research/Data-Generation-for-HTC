...
class Config(object):
	...
	def __init__(self, config_yaml: str, config_override: List[Any] = []):
		...
		self._C.sampling_type = "uniform"
		self._C.gen_templete = 'original'
		#['original','class_keywords','father_class_ketwords','hybrid','rand']
		self._C.keywords_dict_path = "new_label_keywords_dict.json"
		self._C.label_tree_path = "label_tree.json"
