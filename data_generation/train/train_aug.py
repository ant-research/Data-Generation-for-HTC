...
if __name__ == '__main__':
    ...
    common_utils.seed_torch(args.seed)
    args.name = args.data + '-' + args.name
    tokenizer = AutoTokenizer.from_pretrained("/root/pda/pre_trained_model/bert-base-uncased")
    ...
    aug_dataset = AugDataset(device=device, pad_idx=tokenizer.pad_token_id, data_path=args.input_dir, tokenizer=tokenizer)    
    model = ContrastModel.from_pretrained('/root/pda/pre_trained_model/bert-base-uncased', num_labels=num_class,
